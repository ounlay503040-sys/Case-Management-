...
const I18N = {
    ...
    'table.partyA': { km: 'ភាគី (ក) ភាគីស្នើសុំ', en: 'Party A' },
    'table.partyB': { km: 'ភាគី (ខ) ភាគីម្ខាងទៀត', en: 'Party B' },
    ...
    'table.partyA': { km: 'ភាគី (ក) ភាគីស្នើសុំ', en: 'Party A (Applicant)' },
    'table.partyB': { km: 'ភាគី (ខ) ភាគីម្ខាងទៀត', en: 'Party B (Other Party)' },
