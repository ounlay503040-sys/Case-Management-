...
function generateMasterCaseRowHTML(c, rowNum) {
    ...
    return `
        <tr ondblclick="openViewModal('${c.id}')" style="cursor: pointer;" title="ចុចពីរដង ដើម្បីមើលប័ណ្ណ">
            <td class="text-center freeze-col freeze-col-1" style="font-weight: bold; color: #64748b;">${rowNum}</td>
            <td class="text-center freeze-col freeze-col-2" style="white-space: normal; word-wrap: break-word;">${rowNumHtml}</td>
            <td class="freeze-col freeze-col-3"><span class="case-number-tag" style="white-space: normal; word-wrap: break-word;">${c.caseNumber}</span></td>
            <td class="freeze-col freeze-col-4">${formatExcelDate(c.dateReceived)}</td>
